...
public class Employee extends Person {
	...
	public Employee() {}
	public Employee(long empId, double salary) {
		super();
		this.empId = empId;
		this.salary = salary;
	}
	
	public Employee( double salary, long empId) {
		super();
		this.empId = empId;
		this.salary = salary;
	}
	public Employee(long empId, double salary, String firstName, String lastName, LocalDate dob) {
